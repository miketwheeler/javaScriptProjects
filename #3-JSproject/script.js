...
const init = function () {
  ...
  diceEle.classList.add('hidden');
  btnHold.classList.remove('hidden'); // I added this for coolness
  btnRoll.classList.remove('hidden'); // I added this for coolness
...
btnRoll.addEventListener('click', function () {
  if (playing) {
    ...
    // Check for rolled 1: if not 1, else: switch to next player
    if (dice !== 1) {
